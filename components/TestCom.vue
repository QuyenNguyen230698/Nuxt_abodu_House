        ...
        <div v-show="!isLoading" class="grid grid-cols-12 w-full h-full max-h-screen overflow-hidden relative">
            ...
            <div class="col-span-12 lg:col-span-9 h-full flex justify-center items-center">
                <div class="carousel w-full relative order-1 lg:order-2 h-full overflow-hidden">
                    <div v-for="(slide, index) in solution" :key="index" class="relative carousel-item duration-500 ease-in-out translate-all w-full lg:max-h-screen overflow-hidden" 
            ...
            <!-- Option product -->
            <div class="col-span-12 lg:col-span-3 h-auto max-h-screen overflow-y-auto pb-12 lg:pb-0 lg:max-h-screen lg:overflow-y-auto">
                <div class="pt-2 flex flex-col justify-center items-center gap-1">
                    <h1 class="text-3xl font-bold">Configure Your House</h1>
                    <div class="w-40 md:w-24 lg:w-20 bg-orange-900 text-center mx-auto mb-2" style="height: 1px"></div>
                </div>
                ...
                <div class="flex w-full px-5 py-1 lg:h-16 lg:p-5 justify-between items-center fixed lg:sticky bottom-0 bg-white shadow-lg border-t border-gray-400">
