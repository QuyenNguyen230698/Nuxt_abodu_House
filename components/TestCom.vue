<template>
    <div>
        <div v-show="!isLoading" class="flex flex-col lg:flex-row w-full h-full max-h-screen overflow-hidden relative">
            ...
            <!-- Option product -->
            <div class="w-full lg:w-1/3 h-full flex-grow lg:max-h-screen overflow-y-auto pb-12 lg:pb-0">
                ...
                class="flex flex-row justify-between items-center w-full h-12 px-5 border border-gray-400 rounded-3xl hover:border-2 hover:border-orange-900"
                ...
                <div class="flex w-full px-5 py-1 justify-between items-center fixed lg:sticky bottom-0 bg-white shadow-lg border-t border-gray-400">
